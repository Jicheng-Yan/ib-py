### $ANTLR 2.7.7 (20111217): "walker.g" -> "walker.py"$
    ...
    def statement(self, _t,
        ...
        try:      ## for error handling
            ...
            if False:
                ...
                self.statement(_t, while_stat)
                _t = self._retTree
                do_exp=self.expression(_t, block, False)
                _t = self._retTree
                _t = _t97
                _t = _t.getNextSibling()
                ...
                _t = _t.getFirstChild()
                raise_exp=self.expression(_t, block, False)
                _t = self._retTree
                _t = _t107
                _t = _t.getNextSibling()
        ...
        try:      ## for error handling
            ...
            while True:
                ...
                if False:
                    ...
                    _t = _t.getFirstChild()
                    newright=self.expression(_t, other, False)
                    _t = self._retTree
                    if not right:
                       right = ("%s", newright)
                    else:
